    ...
    while done == False:
        ...
        if yellow_score + green_score == bll:
            if yellow_score > green_score:
                doNext_h("Congratulations, Yellow won!", 145, all_sprites_list, block_list, monsta_list, pacman_collide,
                       wall_list, gate, screen, font, clock)
            if green_score > yellow_score:
                doNext_h("Congratulations, Green won!", 145, all_sprites_list, block_list, monsta_list, pacman_collide,
                       wall_list, gate, screen, font, clock)
        ...
        if monsta_hit_list_yellow:
            doNext_h("Game Over, Yellow Wins", 180, all_sprites_list, block_list, monsta_list, pacman_collide, wall_list,
                   gate, screen, font, clock)
        if monsta_hit_list_green:
            doNext_h("Game Over, Green Wins", 180, all_sprites_list, block_list, monsta_list, pacman_collide, wall_list,
                   gate, screen, font, clock)
...
def start_game_client(s):
    ...
    while done == False:
        ...
        try:
            ...
            print("I (the client) didn't get any messages") 
        ...
        if monsta_hit_list_yellow:
            doNext_c("Game Over, Yellow Wins", 180, all_sprites_list, block_list, monsta_list, pacman_collide, wall_list,
                   gate, screen, font, clock)
        if monsta_hit_list_green:
...
def doNext_h(message, left, all_sprites_list, block_list, monsta_list, pacman_collide, wall_list, gate, screen, font, clock):
    while True:
        # ALL EVENT PROCESSING SHOULD GO BELOW THIS COMMENT
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
...
def doNext_c(message, left, all_sprites_list, block_list, monsta_list, pacman_collide, wall_list, gate, screen, font, clock):
    while True:
        # ALL EVENT PROCESSING SHOULD GO BELOW THIS COMMENT
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
